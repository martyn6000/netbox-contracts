"""
Standalone testing base classes for SCB Netbox contract plugin.
    ...
    def add_permissions(self, *permissions: str):
        ...
        Args:
            *permissions: Permission names in format "app.action_model"
                         e.g., "netbox_contracts.add_softwarelicense"
...
class PluginViewTestCase(PluginModelTestCase):
    ...
    def _get_base_url(self) -> str:
        ...
        Returns:
            Base URL string (e.g., "plugins:netbox_contracts:softwarelicense")
        """
